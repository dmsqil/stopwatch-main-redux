...
class _HomeState extends State<Home> {
  ...
  String timeFormate(Duration _duration) {
    ...
    String milliseconds = threeDigits(_duration.inMilliseconds.remainder(1000));
  ...
  void StarWatch() {
    ...
    if (isStart) {
      _timer = Timer.periodic(Duration(milliseconds: 21), (timer) {
        setState(() {
          _elapsedTime += Duration(milliseconds: 21);
        });
      });
    }
